...
namespace MySite.Controllers
{
    public class SearchController : Controller
    {
        ...
        public SearchController(IPostsRepository venuesRepository){
            //_repository = new VenuesRepository();
            _repository = venuesRepository;
        }
       ...
       public ActionResult ShowVenues()
       {
            ...
            return PartialView("/Views/Renderings/SearchPageBody.cshtml", resultsToShow);
       }
        ...
        public ActionResult ShowSearchedVenues(int PageNumber, int ItemsPerPage, string[] Categories, string[] Tags, string TitleQuery, string Lang)
        {
            ...
            return PartialView("/Views/Renderings/SearchPageResults.cshtml", resultsToShow);
        }
    }
}